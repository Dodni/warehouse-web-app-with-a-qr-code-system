...
<body>
    ...
    <div class="container">
        <form id="productForm" method="post" action="TermekInfoAPI/postTermek/" enctype="multipart/form-data">
            ...
            <input type="file" name="termek_kep_feltoltes" accept="image/*" capture="user" placeholder="Kép feltöltés" required><br><br>
        ...
        $('#submitForm').click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Itt lehet a sikeres válasz kezelése
                },
